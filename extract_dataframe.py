...
class TweetDfExtractor:
    ...
    def get_tweet_df(self, save=False)->pd.DataFrame:
        ...
        if save:
            df.to_csv('/home/jay/env_twitter/bin/10Academy_Week0/data/Economic_Twitter_Data/processed_tweet_data.csv', index=False)
...
if __name__ == "__main__":
    ...
    _, tweet_list = read_json("/home/jay/env_twitter/bin/10Academy_Week0/data/Economic_Twitter_Data/Economic_Twitter_Data.json")
